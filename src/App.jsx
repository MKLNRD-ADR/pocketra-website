...
function Navbar() {
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md bg-bg/80 border-b border-card-border/60">
      <nav className="flex items-center justify-between w-full px-6 sm:px-10 py-4">
    ...
    <section id="download" className="py-16 pb-24">
      <div className="max-w-2xl mx-auto px-6 sm:px-10">
        <div className="rounded-[28px] border border-card-border bg-card text-center p-8 sm:p-12">
          ...
          <p className="text-sm text-text-faint">Update these links once your APK or Play Store listing is live.</p>
        </div>
      </div>
    </section>
  );
